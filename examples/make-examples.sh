...
pdm run python ../src/recipe_formatter/main.py -o example1.pdf -v $URL || exit 1
...
pdm run python ../src/recipe_formatter/main.py -o example2.pdf -v -n $URL || exit 1
...
pdm run python ../src/recipe_formatter/main.py -o example3.pdf -v -n -g $URL || exit 1
...
pdm run python ../src/recipe_formatter/main.py -o example4.pdf -v -n -g -r "sub goat's milk" $URL || exit 1
